<p align="center">
  <img src="community-platform/assets/logo.png" alt="NERO Hub Logo" width="250" />
</p>
...
![Landing Page Screenshot](community-platform/assets/landing.png)

**Interactive Dashboard**  
![Community Dashboard Screenshot](community-platform/assets/dashboard.png)

**Video Walkthrough**  
![Application Demo Video](community-platform/assets/demo.webp)

---

## 🌟 System Architecture (End-To-End)

![System Architecture Diagram](./community-platform_NERO/community-platform/assets/diagram-export-24-4-2026-11_09_21-pm.png)
...
1. Navigate to the EVM contracts directory:
   ```bash
   cd community-platform/my-nero-app/evm-contracts
   ```
...
```text
community-platform/
├── assets/                 # Project images, logos, and demos
└── my-nero-app/
